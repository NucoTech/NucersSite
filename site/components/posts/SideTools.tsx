        ...
        return (
            <div className={sideToolsStyle.tools}>
                <div className={sideToolsStyle.toolbox}>
                    ...
                    <div className={sideToolsStyle.singleTool} onClick={() => {
                        document.body.scrollTop = document.getElementById("comments-box").offsetTop
                        document.documentElement.scrollTop = document.getElementById(
                            "comments-box"
                        ).offsetTop
                        console.log(
                            document.getElementById("comments-box").offsetTop
                        )
                    }}>
                        <IconFont
                            type="nucers-comment"
